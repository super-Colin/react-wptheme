  ...
  <div class="envelopeFooter_container-inner">
    <div class="envelopeFooter-top">
      <div class="envelopeFooter-top-links">
        ...
        {/* <!-- <a href="mailto:SuperColin@SuperColin.dev" class="envelopeFooter-bottom-content-emailLink">SuperColin@SuperColin.dev</a> --> */}
        <a href="mailto:SuperColin@SuperColin.dev" class="envelopeFooter-top-link-title" style="color: #fff;">SuperColin@SuperColin.dev</a>
