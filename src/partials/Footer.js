...
const Footer = () => {
  ...
  return (
	<footer className="envelopeFooter_container">
        ...
        <div className="envelopeFooter_container-inner">
            <div className="envelopeFooter-top">
                <div className="envelopeFooter-top-links">
                    <a href="mailto:SuperColin@SuperColin.dev" className="envelopeFooter-top-link-title" style={{color: "#fff"}}>SuperColin@SuperColin.dev</a>
                </div>
            </div>

            <div className="envelopeFooter-middle">
                <div className="envelopeFooter-middle-bgLeft-back"></div>
            ...
            <div className="envelopeFooter-bottom">
                ...
                <div className="envelopeFooter-bottom-icons">
                    ...
                    <a className="envelopeFooter-bottom-icons-icon" href="https://stackoverflow.com/users/11015335/supercolin" target="_blank">
                    ...
                    <a className="envelopeFooter-bottom-icons-icon" href="https://www.linkedin.com/in/colin-a-smith/" target="_blank">
                ...
                <div className="envelopeFooter-bottom-content">
                    {/* <form action="" className="envelopeFooter-bottom-form">
                        ...
                        <div className="envelopeFooter-bottom-form-buttonHolder">
                            <button type="submit" className="envelopeFooter-bottom-form-submit">Submit</button>
                        </div>
                    </form> */}
                    <a href="#" className="envelopeFooter-bottom-toTop">
                        <div className="envelopeFooter-bottom-toTop-arrow scArrow-container">
                            <div className="scArrow"></div>
                        </div>
                        <span className="envelopeFooter-bottom-toTop-top">Top</span>
                    </a>
                </div>
